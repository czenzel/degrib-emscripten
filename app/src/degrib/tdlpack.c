 ...
 *****************************************************************************
 */
int TDLP_Inventory (FILE *fp, sInt4 tdlpLen, inventoryType *inv)
{
   ...
   *pds = sectLen;
   if (fread (pds + 1, sizeof (char), sectLen - 1, fp) + 1 != sectLen) {
 ...
 *****************************************************************************
 */
int TDLP_RefTime (FILE *fp, sInt4 tdlpLen, double *refTime)
{
 ...
 *****************************************************************************
 */
int ReadTDLPRecord (FILE *fp, double **TDLP_Data, uInt4 *tdlp_DataLen,
                    ...
                    double majEarth, double minEarth)
{
   ...
   if (fread (c_ipack + SECT0LEN_WORD * 2, sizeof (char),
              (tdlpLen - SECT0LEN_WORD * 2),
              fp) + SECT0LEN_WORD * 2 != tdlpLen) {
      errSprintf ("Ran out of file\n");
      return -1;
   }
...
/*      errSprintf ("Bitmap data is Not Supported\n");*/
   ...
   if (fread (buffer, sizeof (char), pad, fp) != pad) {
      errSprintf ("Ran out of file\n");
      return -1;
   }
   return 0;
